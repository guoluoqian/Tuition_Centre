...
app.post('/addAdmin', (req, res) => {
    const { username, password, name, dob, email, address, contact, image } = req.body;
    const sql = 'INSERT INTO admin (username,  password, name, dob, email, address, contact, image) VALUES (?, ?, ?, ?, ?, ?, ?, ?)';
    connection.query(sql, [username, password, name, dob, email, address, contact, image], (error, result) => {
        if (error) {
